 ...
 * @param {*} options 
 */
export function renderMediapipeLandmarks(canvasCtx, landmarks, options = {}) {
  

  const drawingUtils = new DrawingUtils(canvasCtx);
  drawingUtils.drawConnectors(landmarks, HandLandmarker.HAND_CONNECTIONS, { color: '#1890ff', lineWidth: 2 });
  drawingUtils.drawLandmarks(landmarks, { color: '#ffcc00', radius: 2.5 });


  // drawConnectors(canvasCtx, landmarks,HandLandmarker.HAND_CONNECTIONS, {color: '#0f0', lineWidth: 2});
